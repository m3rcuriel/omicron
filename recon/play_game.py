...
def play_local_game(white_player, black_player, player_names, should_output=False):
...
if __name__ == '__main__':
    ...
    win_color, win_reason = play_local_game(players[0], players[1], player_names, should_output=args.output)
